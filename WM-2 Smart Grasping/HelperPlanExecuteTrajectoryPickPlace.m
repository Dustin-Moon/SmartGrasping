function [positions, velocities, accelerations, timestamp, success] = HelperPlanExecuteTrajectoryPickPlace(robot, mpcTimeStep, obstacles, endEffector, jointInit, taskFinal, tolerance, avoidCollisions)

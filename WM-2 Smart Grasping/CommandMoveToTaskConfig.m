...
% Copyright 2020 The MathWorks, Inc.
        ...
        mpcTimeStep = 0.6;
        [positions, velocities, accelerations, timestamp, success] = HelperPlanExecuteTrajectoryPickPlace(coordinator.Robot, mpcTimeStep,  coordinator.Obstacles, coordinator.RobotEndEffector, coordinator.CurrentRobotJConfig, taskConfig, tolerance, avoidCollisions);
        if success==0
        ...
        [~,robotStates] = ode15s(@(t,state) HelperTimeBasedStateInputsPickPlace(coordinator.MotionModel, targetTime, targetStates, t, state), trajTimes, initState);
